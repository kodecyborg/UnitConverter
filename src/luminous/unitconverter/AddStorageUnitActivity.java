...
public class AddStorageUnitActivity extends BaseActivity {
	...
	MyStorageUnitConverter converter;
	...
	private void init() {
		...
		tvAddUnitRefVal.setText(Utils.getPref(getActivity(),
				Constant.REFERENCE_UNIT_STORAGE, MyStorageUnitConverter.BYTE));
		...
		HashMap<String, Double> unitList = Utils
				.getCustomUnitStorage(getActivity());
		...
		btnSaveCustomUnit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_STORAGE,
						Utils.getPref(getActivity(),
								Constant.REFERENCE_UNIT_TMP_STORAGE,
								MyStorageUnitConverter.BYTE));
				...
				Utils.saveCustomUnitStorage(getActivity(), unitMap);
				setResult(RESULT_OK);
				finish();
			}
		});
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				refresh(Utils.getPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_STORAGE,
						MyStorageUnitConverter.BYTE), data[position]);

				Utils.setPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_STORAGE, data[position]);
	...
	public void refresh(String oldUnit, String newUnit) {
		MyStorageUnitConverter converter = new MyStorageUnitConverter(
				getActivity());
