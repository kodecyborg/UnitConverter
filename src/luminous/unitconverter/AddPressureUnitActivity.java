...
public class AddPressureUnitActivity extends BaseActivity {
	...
	private void init() {
		...
		tvAddUnitRefVal.setText(Utils.getPref(getActivity(),
				Constant.REFERENCE_UNIT_PRESSURE,
		...
		HashMap<String, Double> unitList = Utils
				.getCustomUnitPressure(getActivity());
		...
		btnSaveCustomUnit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_PRESSURE,
						Utils.getPref(getActivity(),
								Constant.REFERENCE_UNIT_TMP_PRESSURE,
								MyPressureUnitConverter.PASCAL));
				...
				Utils.saveCustomUnitPressure(getActivity(), unitMap);
				setResult(RESULT_OK);
				finish();
			}
		});
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				refresh(Utils.getPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_PRESSURE,
						MyPressureUnitConverter.PASCAL), data[position]);

				Utils.setPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_PRESSURE, data[position]);
	...
	public void refresh(String oldUnit, String newUnit) {
		MyPressureUnitConverter converter = new MyPressureUnitConverter(
				getActivity());
