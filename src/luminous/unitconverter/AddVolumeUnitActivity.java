...
public class AddVolumeUnitActivity extends BaseActivity {
	...
	private void init() {
		...
		tvAddUnitRefVal.setText(Utils.getPref(getActivity(),
				Constant.REFERENCE_UNIT_VOLUME,
		...
		btnSaveCustomUnit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_VOLUME,
						Utils.getPref(getActivity(),
								Constant.REFERENCE_UNIT_TMP_VOLUME,
								MyVolumeUnitConverter.CUBIC_METRE));
				...
				Utils.saveCustomUnitVol(getActivity(), unitMap);
				setResult(RESULT_OK);
				finish();
			}
		});
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				refresh(Utils.getPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_VOLUME,
						MyVolumeUnitConverter.CUBIC_METRE), data[position]);

				Utils.setPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_VOLUME, data[position]);
	...
	public void refresh(String oldUnit, String newUnit) {
		MyVolumeUnitConverter converter = new MyVolumeUnitConverter(
				getActivity());
