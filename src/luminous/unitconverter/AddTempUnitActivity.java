...
public class AddTempUnitActivity extends BaseActivity {
	...
	private void init() {
		...
		tvAddUnitRefVal
				.setText(Utils.getPref(getActivity(),
						Constant.REFERENCE_UNIT_AREA,
		...
		btnSaveCustomUnit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_AREA,
						Utils.getPref(getActivity(),
								Constant.REFERENCE_UNIT_TMP_AREA,
								MyAreaUnitConverter.SQUARE_METRE));
				...
				Utils.saveCustomUnitArea(getActivity(), unitMap);
				setResult(RESULT_OK);
				finish();
			}
		});
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				refresh(Utils.getPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_AREA,
						MyAreaUnitConverter.SQUARE_METRE), data[position]);

				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_TMP_AREA,
						data[position]);
	...
	public void refresh(String oldUnit, String newUnit) {
		MyAreaUnitConverter converter = new MyAreaUnitConverter(getActivity());
