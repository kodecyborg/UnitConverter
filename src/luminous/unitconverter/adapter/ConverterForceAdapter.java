...
import luminous.unitconverter.objects.MyForceUnitConverter.MyUnit;
...
public class ConverterForceAdapter extends ArrayAdapter<MyUnit> {
	...
	public ConverterForceAdapter(Context c, int textViewResourceId) {
