...
public class AddTimeUnitActivity extends BaseActivity {
	...
	private void init() {
		...
		tvAddUnitRefVal.setText(Utils.getPref(getActivity(),
				Constant.REFERENCE_UNIT_TIME, MyTimeUnitConverter.SECOND));
		...
		btnSaveCustomUnit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_TIME,
						Utils.getPref(getActivity(),
								Constant.REFERENCE_UNIT_TMP_TIME,
				...
				Utils.saveCustomUnitTime(getActivity(), unitMap);
				setResult(RESULT_OK);
				finish();
			}
		});
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				refresh(Utils.getPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_TIME,
						MyTimeUnitConverter.SECOND), data[position]);

				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_TMP_TIME,
						data[position]);
	...
	public void refresh(String oldUnit, String newUnit) {
		MyTimeUnitConverter converter = new MyTimeUnitConverter(getActivity());
