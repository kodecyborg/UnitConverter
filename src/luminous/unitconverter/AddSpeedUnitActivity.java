...
public class AddSpeedUnitActivity extends BaseActivity {
	...
	private void init() {
		...
		HashMap<String, Double> unitList = Utils
				.getCustomUnitSpeed(getActivity());
		...
		btnSaveCustomUnit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_SPEED,
						Utils.getPref(getActivity(),
								Constant.REFERENCE_UNIT_TMP_SPEED,
								MySpeedUnitConverter.METRE_PER_SEC));
				...
				Utils.saveCustomUnitSpeed(getActivity(), unitMap);
				setResult(RESULT_OK);
				finish();
			}
		});
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				refresh(Utils.getPref(getActivity(),
						Constant.REFERENCE_UNIT_TMP_SPEED,
						MySpeedUnitConverter.METRE_PER_SEC), data[position]);

				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_TMP_SPEED,
						data[position]);
	...
	public void refresh(String oldUnit, String newUnit) {
		MySpeedUnitConverter converter = new MySpeedUnitConverter(getActivity());
