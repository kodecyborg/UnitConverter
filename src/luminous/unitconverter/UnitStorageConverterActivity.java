...
import luminous.unitconverter.adapter.ConverterStorageAdapter;
import luminous.unitconverter.dslv.DragSortListView;
import luminous.unitconverter.objects.MyStorageUnitConverter;
import luminous.unitconverter.objects.MyStorageUnitConverter.MyUnit;
...
public class UnitStorageConverterActivity extends SlidingBaseFragmentActivity {

	DragSortListView lvUnitConverter;
	ConverterStorageAdapter mAdapter;
	...
	private void init() {
		...
		mAdapter = new ConverterStorageAdapter(getActivity(),
	...
	private void checkUnitAndRefresh() {
		...
		if (!unitList.contains(selectedUnit)) {
			Utils.setPref(getActivity(), Constant.SELECTED_UNIT_STORAGE,
