...
public class AddLengthUnitActivity extends BaseActivity {
	...
	private void init() {
		...
		tvAddUnitRefVal.setText(Utils.getPref(getActivity(),
				Constant.REFERENCE_UNIT_LENGTH, MyLengthUnitConverter.METRE));
		...
		HashMap<String, Double> unitList = Utils
				.getCustomUnitLength(getActivity());
		...
		btnSaveCustomUnit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Utils.setPref(getActivity(), Constant.REFERENCE_UNIT_LENGTH,
